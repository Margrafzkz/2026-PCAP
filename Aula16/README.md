Documento sobre advinhe.py

# 🎮 Adivinhe o Número
​
Jogo de adivinhação feito em Python na disciplina PCAP (Aula 16).
Com um número aleatorio q o computador define, a gente tenta acerta com certa quantidade de vidas (chances) definidas, tendo 3 níveis de dificuldade.
​
## ▶️ Como jogar
